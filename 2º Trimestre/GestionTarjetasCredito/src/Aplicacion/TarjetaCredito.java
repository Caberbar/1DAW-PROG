...
public class TarjetaCredito {
     ...
     * 
     * @throws Nombre, En caso de que un nombre introducido por teclado no pase un patron de reglas lanzara una excepción.
     * @throws NIE, En caso de que un NIE/NIF/CIF introducido por teclado no pase un patron de reglas lanzara una excepción.
     * @throws PIN, En caso de que un PIN introducido por teclado no contenga 4 numeros(enteros) lanzara una excepción.
     * @throws Limite, En caso de que un Limite introducido por teclado no se encuentre entre el rango de 500 y 5000 incluidos lanzara una excepción.
     * @throws Tarjeta, En caso de que un Número de tarjeta introducido por teclado su digito de control no coincida con el resto del número lanzara una excepción.
     */
    ...
    public TarjetaCredito(TarjetaCredito tarjeta) {
        ...
        this.movimientos = new Movimiento[50];
        for(int movi = 0; movi < 50; movi++) {
            this.movimientos[movi] = new Movimiento(tarjeta.movimientos[movi]);
        }
    }
     ...
     * 
     * @throws Pagar, En caso de que el ususario no introduzca una cantidad positiva lanzara una excepción.
     * @throws Limite, En caso de que el ususario haya superado el limite de la tarjeta en otros movimientos lanzara una excepción.
    ...
    public String movimientos(int numero) {
        StringBuilder movi = new StringBuilder();
        int cont = this.numeroMovimientos();
        if(numero>cont){
            throw new IllegalArgumentException("No hay movimientos suficientes");
        }
        cont -= 1;
        for (int i = cont; i > cont-numero; i--) {
            movi.append(movimientos[i]);
            movi.append("\n");
        }
        return movi.toString();
    }
    ...
    public int numeroMovimientos() {
        ...
        while (this.movimientos[numeroMovimientos] != null) {
            numeroMovimientos++;
        }
