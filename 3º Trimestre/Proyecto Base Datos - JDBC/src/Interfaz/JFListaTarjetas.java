 ...
 */
package Interfaz; // Adjuntar al proyecto el DOOM de la base de datos - Cuando creo un movimiento(pago) debo insertarlo en el objeto no en la base de datos

import Aplicación.ModeloTarjetaCredito;
...
public class JFListaTarjetas extends javax.swing.JFrame {
    ...
    public JFListaTarjetas() {
        initComponents();
        modelo = new ModeloTarjetaCredito(TarjetaCreditoDAO.añadirTarjetaArray());
    ...
    private void jmiCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmiCrearActionPerformed
        ...
        if (crear.valido()) {
            ...
            if (TarjetaCreditoDAO.crearTarjeta(tarjeta)) {
    ...
    private void jmiEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmiEliminarActionPerformed
        ...
        if (pos < 0) {
            ...
            if (opcion == 0) {
                if (TarjetaCreditoDAO.eliminarTarjeta(modelo.getTarjeta(pos).getNumero())) {
    ...
    private void jmiMovimientosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmiMovimientosActionPerformed
        ...
        if (pos < 0) {
            ...
            if (!TarjetaCreditoDAO.exisMovimientos(modelo.getTarjeta(pos).getNumero())) {
                JOptionPane.showMessageDialog(this, "La tarjeta no tiene movimientos.", "AVISO", JOptionPane.WARNING_MESSAGE);
            } else {
                JDListaMovimientos listamovimientos = new JDListaMovimientos(this, true, modelo.getTarjeta(pos).getMovimientos());
