 ...
 */
package ProyectoJDBC; // Adjuntar al proyecto el DOOM de la base de datos - Cuando creo un movimiento(pago) debo insertarlo en el objeto no en la base de datos

import ProyectoJDBC.ModeloTarjetaCredito;
