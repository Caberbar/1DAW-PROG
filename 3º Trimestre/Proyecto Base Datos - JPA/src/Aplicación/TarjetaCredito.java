...
public class TarjetaCredito implements Serializable {
    ...
    @Column(name = "documento_identidad") //Nombre de la columna
    private String nif;
    @Column(name = "pin") //Nombre de la columna
    private String pin;
    @Column(name = "limite_credito") //Nombre de la columna
    private int limite;
//    private int mes; - CAMBIAR
//    private int anno;
    @Column(name = "fecha_caducidad") //Nombre de la columna
    private LocalDate fecha;
    @Id //Clave primaria
    @Column(name = "numero_tarjeta") //Nombre de la columna
    private String numero;
    @Transient //Ignorar este atributo
    private String cvv;
    @OneToMany(mappedBy = "tarjetaCredito") //Nombre de la columna
    private ArrayList<Movimiento> movimientos = new ArrayList<>();

    /**
     * Construye el objeto TarjetaCredito. Crea una instancia de TarjetaCredito
    ...
    public TarjetaCredito(String nombre, String nif, String pin, int limite, String numero) {
        ...
        this.pin = pin;
        this.limite = limite;
        this.fecha = LocalDate.now().plusYears(5);
