            ...
            if (Validar.validarCantidad(jtfCantidad.getText())) {
                ...
                if (Validar.validarConcepto(jtfConcepto.getText(), 51)) {
                    ...
                    if (cantidad > tarjeta.getLimite() || gastado > tarjeta.getLimite() || cantidad < 1 || (gastado + cantidad) > tarjeta.getLimite()) {
                        ...
                        Movimiento movimiento = new Movimiento(Integer.parseInt(jtfCantidad.getText()), jtfConcepto.getText());
                        TarjetaCreditoJPAController.realizarPago(tarjeta.getNumero(), movimiento);
                        tarjeta.pagar(movimiento);
                        pagado = true;
                        dispose();
                    }
                }
            } else {
                JOptionPane.showMessageDialog(this, "Debes introducir una cantidad numérica.", "ERROR", JOptionPane.ERROR_MESSAGE);
            }
        }
